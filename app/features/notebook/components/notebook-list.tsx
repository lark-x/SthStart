      ...
      {isLoading ? (
        ...
        <div className="space-y-10">
          <section className="space-y-4">
            <div className="flex items-center justify-between pb-2 border-b border-[rgb(24_32_29/10%)]">
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {visibleNotes.map((note) => (
                <Link
                  ...
                  className={`group relative flex flex-col justify-between p-5 min-h-[220px] rounded-[3px_22px_3px_3px] border border-[rgb(24_32_29/14%)] bg-[#fffdf8] hover:border-[#e45d35]/60 hover:shadow-md transition-all duration-200 note-card note-kind-${note.kind}`}
                >
                  <div>
                  ...
                  <div className="flex items-center justify-between pt-3 mt-4 border-t border-[rgb(24_32_29/8%)] text-[10px] text-[#68716d]">
          ...
          {/* Lore Shelves */}
          <section className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-[rgb(24_32_29/12%)]">
            <div className="p-5 rounded-[4px_18px_4px_4px] bg-[#fffdf8] border border-[rgb(24_32_29/12%)] space-y-3">
