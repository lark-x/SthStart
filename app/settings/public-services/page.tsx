...
export default function PublicServicesPage() {
  return <main className="portal-shell settings-shell">
    <header className="portal-header"><Link className="brand" href="/"><span className="brand-mark">S</span><span>SthStart</span></Link><Link className="text-link" href="/">← 返回主页</Link></header>
